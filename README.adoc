...
[source,shell]
----
./vulnscout.sh --name example --spdx .vulnscout/example/input/example.rootfs.spdx.tar.zst
----
...
[source,shell]
----
./vulnscout.sh --name example-spdx3 --spdx .vulnscout/example-spdx3/input/core-image-minimal-qemux86-64.rootfs.spdx.json
----
